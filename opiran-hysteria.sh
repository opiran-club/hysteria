...
menu() {
    ...
    echo -e "${WHITE}────────────────────────────────────────────────────────"
    echo -e "            ${YELLOW} OPIran Hysteria${PLAIN}"
    echo ""
    echo -e " ${GREEN}TG-Group${NC} >>>> ${MAGENTA}@OPIranCluB ${NC}"
    echo -e "${WHITE}────────────────────────────────────────────────────────${NC}"
    echo ""
    echo -e "${CYAN} Hysteria status${NC} => $status"
    echo ""
    echo -e "  ${RED}1)${PLAIN} =>  ${CYAN}Install Hysteria Server ${NC}"
    echo -e "  ${RED}2)${PLAIN} =>  ${CYAN}Start & Enable Hysteria Server${NC}"
    echo -e "  ${RED}3)${PLAIN} =>  ${CYAN}stop & Disable Hysteria Server ${NC}"
    echo ""
    echo -e "${WHITE}────────────────────────────────────────────────────────${NC}"
    echo ""
    echo -e "  ${RED}4)${PLAIN} =>  ${CYAN}Restart Hysteria ${NC}"
    echo -e "  ${RED}5)${PLAIN} =>  ${YELLOW}Uninstall Hysteria Server ${NC}"
    echo -e "  ${RED}E)${PLAIN} =>  ${YELLOW}Exit${NC}"
    echo ""
    read -p " Enter option number [0-5 / E]：" answer
    case $answer in
        1) installHysteria ;;
        2) start_hysteria ;;
        3) stop_hysteria ;;
